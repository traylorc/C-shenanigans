...
namespace Dictionary
{
    class Program
    {
        ...
        {
            //initialize list and give name (ints)
            int[] ints =
            {
            ...
            //create var dictionary and store in list value
            var dictionary = new Dictionary<int, int>();
            //create instances for each value (left number is key, right is how many times occured(starts from 0))
            dictionary.Add(0, 0);
            dictionary.Add(1, 0);
            dictionary.Add(2, 0);
            dictionary.Add(3, 0);
            ...
            dictionary.Add(8, 0);
            dictionary.Add(9, 0);
            //each time you encounter a specific key, add 1 to the count of that key
